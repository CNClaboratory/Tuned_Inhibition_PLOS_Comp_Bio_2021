function TI_KML2015_1A_md_Cd_search_loop(alpha)
...
for i_rep = 1:sim.nreps
    perf = TI_KML2015_1A_md_Cd_search(param, sim);
...
filename = ['TI_KML2015_1A_md_Cd_search_alpha=' num2str(sim.alpha)];

if savedata
    results  = v2struct(d, rt, md_Cd, presp, B_tau2md, md_target, tau_fit);
