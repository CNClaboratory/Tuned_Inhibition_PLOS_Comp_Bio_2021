function TI_KML2015_2B_final_fit_Cx_loop(sigma)
...
param.tau   = 62;    % value for tau derived from md_Cx_search fit for sigma=0.1
...
for i_rep = 1:sim.nreps
    perf = TI_KML2015_2B_final_fit_Cx(param, sim);
...
filename = ['TI_KML2015_2B_final_fit_Cx_sigma=' num2str(sigma)];
